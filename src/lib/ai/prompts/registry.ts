...
const REF_VIDEO_H3_RULES = [
  ...
  "",
  "non_diegetic_music:",
  "箫声与古筝交织，极轻(pp)开始，5.0s处打击乐轻点一记渐强至中弱(mp)，持续至视频结束（配乐应贯穿整段，不要逐镜渐弱至无声）。",
  "",
  ...
  "",
  "non_diegetic_music:",
  "乐器+速度+动态。如: 大提琴缓慢弦乐，极轻(pp)开始，渐强至中弱(mp)，持续至视频结束（配乐应贯穿整段，不要逐镜渐弱至无声）。",
  "",
  "=== 质量检查清单(输出前逐项自检) ===",
  "[ ] 6个section全部包含，无遗漏",
  ...
  "[ ] 对白使用 <d> 格式，语言标注正确",
  "[ ] overall_soundscape 含时间段标签，non_diegetic_music 动态标记正确，持续至视频结束（不逐镜渐弱）",
  "[ ] 运镜术语来自H3术语表",
